...
public class SentinelRedisDefinitionProvider implements RedisDefinitionProvider {
    ...
    public boolean checkAndApplyDefaultConfig(RedisDefinition redisDefinition) {
        ...
        Assert.isTrue(!StringUtils.isEmpty(sentinelRedisDef.getId()), "RedisDefinition.id 不能为空");
        Assert.isTrue(!StringUtils.isEmpty(sentinelRedisDef.getSentinels()), "[" + sentinelRedisDef.getId() + "]RedisDefinition.sentinels 不能为空");
        Assert.isTrue(!StringUtils.isEmpty(sentinelRedisDef.getMasterName()), "[" + sentinelRedisDef.getId() + "]RedisDefinition.masterName 不能为空");
